...
public class BudgetAdapter2 extends RecyclerView.Adapter<BudgetAdapter2.BudgetViewHolder> {
    ...
    public BudgetAdapter2(List<Budget> budgetList, Context context, DatabaseHelper databaseHelper, int userId) {
